...
var SetLALiterals = {
                ...
                addressType_AreaName: "Area Name", /*Area Name is being used in a reg expression, if you change this search code for /^Area\sName$/*/
...
*/                          
    ...
    AddressStatusReasonRequired: "You indicated this unit is unable to be worked.  You must supply a reason.",
                ...
                fld_NameUrban: "Name of Urbanizacion",
    ...
    msg_NullAttemptContactResponseError: "Invalid Selection, An answer must be selected.",/*DLCensus.Messages.Msg_NullAttemptContactResponseError*/
};
